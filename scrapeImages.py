...
def get_query_url(query):
    return "https://www.google.co.in/search?q=%s&tbs=ic:trans,sur:fc&tbm=isch&source=lnt&sa=X" % query
...
def run(query, save_directory='./art', num_images=100):
...
def main():
    ...
    parser.add_argument('-d', '--directory', default='./art', type=str, help='save directory')
